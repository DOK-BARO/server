...
import kr.kro.dokbaro.server.core.auth.adapter.out.web.EmailNotExistException
...
class KakaoAccountLoader(
	private val resourceClient: kr.kro.dokbaro.server.core.auth.oauth2.adapter.out.web.kakao.external.KakaoResourceClient,

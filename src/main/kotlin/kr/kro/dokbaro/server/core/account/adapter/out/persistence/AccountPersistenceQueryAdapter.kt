...
class AccountPersistenceQueryAdapter(
	...
	override fun findByMemberId(memberId: Long): AccountPassword? = accountQueryRepository.findByMemberId(memberId)

	override fun findByEmail(email: String): AccountPassword? = accountQueryRepository.findByEmail(email)
}